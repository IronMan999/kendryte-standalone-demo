...
void region_layer_output(obj_info_t *obj_info)
{
    obj_info->obj_number = 0;
    for (int i = 0; i < region_layer_boxes; ++i) {
        ...
        if (prob > region_layer_thresh) {
            volatile box *b = boxes + i;
            obj_info->obj[obj_info->obj_number].x1 = b->x * region_layer_img_w -
                                                    (b->w * region_layer_img_w / 2);
            obj_info->obj[obj_info->obj_number].y1 = b->y * region_layer_img_h -
                                                    (b->h * region_layer_img_h / 2);
            obj_info->obj[obj_info->obj_number].x2 = b->x * region_layer_img_w +
                                                    (b->w * region_layer_img_w / 2);
            obj_info->obj[obj_info->obj_number].y2 = b->y * region_layer_img_h +
                                                    (b->h * region_layer_img_h / 2);
            obj_info->obj_number++;
        }
    }
